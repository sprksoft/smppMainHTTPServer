...
function updateFunPreview(shouldAnimate, extraFun) {
    ...
    if (extraFun) {
        ...
        document.getElementById("volume-text").innerHTML = `Please turn on volume for the full experience`
        ...
        document.getElementById("volume-icon").addEventListener("click", function () {
            ...
            document.getElementById("volume-text").innerHTML = `Press <span id="fun-continue-button" class="accent-text">here</span> to continue`
